...
# datadir=/home/qszhu/workspace/2.nmyc/1.align/*/2.range300
# cd $wdir
...
#程序任务需要：循环读取符合的文件
for i in /home/qszhu/workspace/3.epidermal/0.cutadapt_QC/1.cutadapt/*R1*;   
do
	read -u 1000   #读取管道文件的一行，每次读取管道就会减少一个空行
	{
		...
		#bamCoverage -b $i -o $wdir/$o.bw --normalizeUsingRPKM -p 8 –ignoreDuplicates
		#o=${i##*/};o=${o/sorted/txt}
		nohup hisat2 --dta-cufflinks -p 32 -x /home/share/hisat2_index/new_index/hg19_tran -1 $i -2 ${i/R1/R2} -S /home/qszhu/workspace/3.epidermal/1.align/test_all_reads/$o.test.sam > /home/qszhu/workspace/3.epidermal/1.align/test_all_reads/$o.test.log
		###############################
